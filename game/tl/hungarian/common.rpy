...
translate hungarian strings:
    ...
    new "Feolvasó program kikapcsolva."

    # renpy/common/00accessibility.rpy:29
    old "Clipboard voicing enabled. "
    new "Clipboard voicing bekapcsolva. "

    # renpy/common/00accessibility.rpy:30
    old "Self-voicing enabled. "
    new "Felolvasó program bekapcsolva. "
    ...
    new "vízszintes görgetés"

    # renpy/common/00accessibility.rpy:36
    old "vertical scroll"
    new "függőleges görgetés"
    ...
    new "Sörköz méretezés"

    # renpy/common/00accessibility.rpy:169
    old "Self-Voicing"
    new "Felolvasó program"
    ...
    new "Biztosan ki akarsz lépni?"

    # renpy/common/00gui.rpy:379
    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "Biztosan vissza akarsz térni a főmenübe?\nEzzel elveszíted a nem mentett játékállásodat."
